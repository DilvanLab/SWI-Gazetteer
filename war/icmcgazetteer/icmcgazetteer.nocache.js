...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "icmcgazetteer" because\n';
  ...
  $wnd.__gwt_activeModules['icmcgazetteer'] = {
    'moduleName' : 'icmcgazetteer',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/icmcgazetteer.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['icmcgazetteer'].superdevmode = true;

  var expectedSuffix = '/icmcgazetteer.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + icmcgazetteer + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:icmcgazetteer';
  var devModeSessionKey = '__gwtDevModeSession:icmcgazetteer';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':61244';
  var nocacheUrl = serverUrl + '/icmcgazetteer/icmcgazetteer.nocache.js';
  ...
  $wnd.__gwt_activeModules['icmcgazetteer'].canRedirect = true;
  $wnd.__gwt_activeModules['icmcgazetteer'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING icmcgazetteer';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/icmcgazetteer?user.agent=' + ua + '&_callback=' + callback;
